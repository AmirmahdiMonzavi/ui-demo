...
export type EyeSlashPropsType = {
  className?: string;
  onClick?: MouseEventHandler<SVGSVGElement>;
};

const EyeSlash = ({ className, onClick }: EyeSlashPropsType) => {
  return (
    <svg
      onClick={onClick}
    ...
    >
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M6.31325 9.68652L1.33325 14.6665" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M14.6668 1.3335L9.68677 6.3135" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
